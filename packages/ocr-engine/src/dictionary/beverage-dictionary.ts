 ...
 * Pure data file: maps common OCR misreadings to correct beverage terms.
 *
...
export const BEVERAGE_TERMS: Record<string, string> = {
...
/**
 * Returns a shallow copy of the built-in beverage dictionary.
 * Callers get their own object so mutations do not affect the canonical data.
 */
export function getBuiltInDictionary(): Record<string, string> {
  return { ...BEVERAGE_TERMS };
}

/**
 * Returns the number of entries in the built-in beverage dictionary.
 */
export function getBuiltInEntryCount(): number {
  return Object.keys(BEVERAGE_TERMS).length;
}
